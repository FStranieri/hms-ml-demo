...
class LoadPhotoActivity : BaseActivity() {
        ...
        for (i in categories.indices) {
            ...
            textView.setOnClickListener {
                val setting = MLImageSegmentationSetting.Factory().setAnalyzerType(
                    MLImageSegmentationSetting.IMAGE_SEG
                ).create()
    ...
    companion object {
        ...
        private val CATEGORIES =
            arrayOf("背景", "人", "天空", "绿植", "食物", "猫狗", "建筑", "花朵", "水面", "沙滩", "山坡")
        private val CATEGORIES_EN = arrayOf(
            "Background",
            "People",
            "Sky",
            "Plant",
